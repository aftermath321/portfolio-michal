            ...
            <div className=' flex-col p-4 flex justify-center items-center w-full'>
                ...
                <div className='grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:py-10 '>
                    ...
                    <div data-Aos='fade-right' className='flex-row flex group '>
                        <SiMysql size={80} className='group-hover:text-[#fb7e14] group-hover:-translate-y-6 duration-500' />
                    ...
                    <div data-Aos='fade-right' className='flex-row flex group '>
                        <SiMongodb size={80} className='group-hover:text-[#fb7e14] group-hover:-translate-y-6 duration-500' />
                    ...
                    <div data-Aos='fade-right' className='flex-row flex group '>
                        <SiJavascript size={80} className='group-hover:text-[#fb7e14] group-hover:-translate-y-6 duration-500' />
                    ...
                    <div data-Aos='fade-right' className='flex-row flex group'>
                        <SiCss3 size={80} className='group-hover:text-[#fb7e14] group-hover:-translate-y-6 duration-500' />
                    ...
                    <div data-Aos='fade-right' className='flex-row flex group '>
                        <SiHtml5 size={80} className='group-hover:text-[#fb7e14] group-hover:-translate-y-6 duration-500' />
                    ...
                    <div data-Aos='fade-right' className='flex-row flex group '>
                        <SiTailwindcss size={80} className='group-hover:text-[#fb7e14] group-hover:translate-y-6 duration-500' />
                    ...
                    <div data-Aos='fade-right' className='flex-row flex group '>
                        <SiNodedotjs size={80} className='group-hover:text-[#fb7e14] group-hover:translate-y-6 duration-500' />
                    ...
                    <div data-Aos='fade-right' className='flex-row flex group '>
                        <SiReact size={80} className='group-hover:text-[#fb7e14] group-hover:translate-y-6 duration-500' />
