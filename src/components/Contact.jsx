...
const Contact = () => {
  return (
    <div
      className="mx-auto flex justify-center items-center h-screen w-full p-4 text-black tracking-wider"
      name="contact">
      <form
        method="POST"
        ...
        <div className="py-4 text-center justify-center items-center">
          ...
          <p className="text-white">
            ...
            <span className="text-[#fb7e14]">michal.kielbasa1994@gmail.com</span>
          </p>
        </div>
