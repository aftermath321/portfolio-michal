      ...
      <div>
        <nav>
          <ul className="hidden md:flex cursor-pointer sticky">
            <Link to="home" smooth="true" duration={300}>
              <li className="text-xl hover:text-[#fb7e14] ">Home</li>
            </Link>
            <Link to="about" smooth="true" duration={300}>
              <li className="text-xl hover:text-[#fb7e14]">About</li>
            </Link>
            <Link to="skills" smooth="true" duration={300}>
              <li className="text-xl hover:text-[#fb7e14]">Skills</li>
            </Link>
            <Link to="work" smooth="true" duration={300}>
              <li className="text-xl hover:text-[#fb7e14]">Work</li>
            </Link>
            <Link to="contact" smooth="true" duration={300}>
              <li className="text-xl hover:text-[#fb7e14]">Contact</li>
            </Link>
          </ul>
        </nav>
      </div>
      ...
      <div className="hidden fixed bg-white lg:flex left-0 top-[35%]">
        <ul>
          ...
          <li className="w-[160px] h-[50px] text-red-600 items-center justify-center flex ml-[-100px] duration-300 hover:ml-[-10px]">
            <a target="_blank" href="mailto:" className="flex justify-between items-center w-full ">
